...
public class DashStepDef { // Class 12 Day Time is 1:44H

	WebDriver driver;
	DashboardPage dashPage;

	@Given("^user go to Orange Hrm home page$")
	public void user_go_to_Orange_Hrm_home_page() throws Throwable {  // Class 12 Day Time is 3:00H
	...
	public void user_enter_valid_username_and_password() throws Throwable { // Class 12 Day Time is 3:04H
	...
	public void user_click_on_the_log_in_button() throws Throwable { // Class 12 Day Time is 3:12H
	...
	@Then("^user verify the page title as \"([^\"]*)\"$") // Class 12 Day Time is 3:28H
	...
	@Then("^user log out$") // Class 12 Day Time is 3:44H
	public void user_log_out() throws Throwable {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		dashPage.logOut();
	}

	@Then("^user close browser$") // Class 12 Day Time is 4:03H
